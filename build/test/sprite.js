          ...
          describe('Initialization and workflow', function () {
            ...
            it('draw a sprite', function (done) {
              ...
              sprite.build().then(function (sprite) {
                ...
                var imageData = context.getImageData(12, 6, 1, 1);
            ...
            it('can play a sprite flipped', function (done) {
              var sprite = new Sprite({ // guybrushWalkingRight
                sheet: {
                  name: './assets/sprite-sheets/guybrush.png',
              ...
              sprite.build().then(function () {
                ...
                sprite.tick({ delta: 10, x: sprite.frame.width / 2, y: sprite.frame.height / 2, context: context });
                var imageData = context.getImageData(4, 6, 1, 1);
                if (navigator.userAgent.indexOf('PhantomJS') === -1) {
                  ...
                  // PhantomJS seems to perform some image smoothing
