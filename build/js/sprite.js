        ...
        _createClass(Sprite, [{
          ...
          value: function draw(x, y, context) {
            if (this.frame && context) {
              ...
              context.drawImage(this.image, this.frame.left, this.frame.top, this.frame.width, this.frame.height, x - this.frame.width / 2, y - this.frame.height / 2, this.frame.width, this.frame.height);
              context.restore();
            }
          }
        }, {
